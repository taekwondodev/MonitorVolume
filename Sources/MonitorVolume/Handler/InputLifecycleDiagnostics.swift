...
final class InputLifecycleDiagnostics {
    private let logger = Logger(subsystem: "dev.taekwondodev.MonitorVolume", category: "input-lifecycle")
    ...
    static func configured(arguments: [String] = CommandLine.arguments) -> InputLifecycleDiagnostics? {
        ...
        case .enabled:
            ...
            return diagnostics
        case .duplicateFlag:
            Logger(subsystem: "dev.taekwondodev.MonitorVolume", category: "input-lifecycle")
